...
<head>
    ...
    <title>Ambil Stok Barang - Panti Wredha BDK</title>
...
<body class="bg-admin">
    ...
    <div id="ambilStokApp" class="admin-wrapper" v-cloak>
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <ul class="collapse show list-unstyled sidebar-submenu" id="barangSub">
                        ...
                        <li><a href="{{ url('/admin/ambil-stok') }}" class="active"><i class="fas fa-minus-square"></i> Ambil Stok Barang</a></li>
                    </ul>
                </li>
            </ul>
                ...
                <div class="form-container">
                    ...
                    <div class="form-group-row">
                        ...
                        <datalist id="barangOptions">
                            <option v-for="item in availableItems" :value="item.nama">Sisa: @{{ item.sisa_stok }}</option>
                        </datalist>
                    </div>
