// ==========================================
// 3. generate-laporan.js - FIXED
// ==========================================
// File: public/assets/js/generate-laporan.js
...
createApp({
    data() {
        return {
            searchQuery: '', isiLaporan: '', previewImage: null, fileName: '', item: null,
            emailDonatur: '', unreadCount: 0, currentUrl: window.location.href, currentPage: 'donasi'
        }
    },
    computed: {
        filteredList() { return []; }
...
Semoga kebaikanmu dibalas dengan berlipat ganda.`;
            ...
            window.location.href = '/admin/laporan-donasi';
        }
    },
    methods: {
        ...
        async generateAndSendPDF() {
            ...
            setTimeout(() => {
                ...
                if (this.previewImage) {
                    ...
                    } catch (err) { console.log("Error menambahkan gambar ke PDF"); }
                }
                ...
                logs.push({ text: `Admin mengirim laporan donasi kepada: ${this.emailDonatur}`, time: jam });
                ...
                Swal.fire({
                    ...
                    window.location.href = '/admin/laporan-donasi?status=sent';
                });
            }, 2000);
        },
        logoutAdmin() {
